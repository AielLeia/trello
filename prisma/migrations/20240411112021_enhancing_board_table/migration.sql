/*
  ...
  - Added the required column `imageThumbFull` to the `Board` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE `Board` ADD COLUMN `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    ...
    ADD COLUMN `imageThumbFull` TEXT NOT NULL,
